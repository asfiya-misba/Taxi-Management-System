      ...
      <div class="row">
        <div class="col-md-5 col-md-push-3">
          <div class="banner_content">
            <h1>Welcome to Taxi Town</h1>
            <p>We have a wide range of taxi's to choose from. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Taxi<span>Town</span></h2>
      <p>Looking to book a taxi without any hassle then this is just the right place for you. Choose from a wide range of cars at the comfort of your home. </p>
...
<span class="price">Rs.<?php echo htmlentities($result->PricePerDay);?> /Km</span> 
</div>
